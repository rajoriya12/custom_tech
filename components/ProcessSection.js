      ...
      <div className="step-wrapper right">
        ...
        <div className="card animate-right">
          ...
          <div className="content">
            ...
            <h2 className="title">
              We Listen for the "Why"
            </h2>

            <p className="description">
              Before we touch a keyboard, we figure out why you’re building
              this in the first place. We dig for the friction in your current
              process so we can create a solution that actually clears the path.
            </p>
        ...
        <div className="card animate-left">
          ...
          <div className="content">
            ...
            <p className="description">
              ...
              We want your team and your customers to actually want
              to use the tool.
            </p>
      ...
      <div className="step-wrapper right">
        ...
        <div className="card animate-right">
          ...
          <div className="content">
            ...
            <p className="description">
              We hand-pick the right technology to build a robust,
              custom foundation. No templates, no shortcuts.
            </p>
      ...
      <div className="step-wrapper left">
        ...
        <div className="card animate-left">
          ...
          <div className="content">
            ...
            <p className="description">
              We collaborate with you on the rollout so it feels
