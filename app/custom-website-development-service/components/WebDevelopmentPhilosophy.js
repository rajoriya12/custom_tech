...
const philosophyData = [
    {
        ...
        description:
            "We start with clarity.If positioning isn’t sharp, design won’t save it.",
    },

    {
        ...
        description:
            "We design for real behavior.Not ideal users. Not assumed patterns.",
    },

    {
        ...
        description:
            "We build for longevity.Scalable architecture. Clean code. Structured foundations.",
    },

    {
        ...
        description:
            "We launch with intention.No chaos. No forced adoption. No fragile systems.",
    },

    {
        ...
        description:
            "We refine based on data.Usage reveals truth. We follow it.",
    },

    {
        ...
        description:
            "User behavior is our compass. Every click and scroll guides us.",
    },
];
                    ...
                    {philosophyData.map((item, idx) => (
                        ...
                        >
                            ...
                            <div className="border border-dark h-100 px-4 py-3 d-flex flex-column bg-transparent">
                                ...
                                {/* Icon */}
                                <div
                                    className="d-flex align-items-center justify-content-center flex-shrink-0 mb-2"
                                    style={{
                                        width: '48px',
                                        height: '48px',
